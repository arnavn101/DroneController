...
// detect_before_after_turn list : (1 --> detection before turn, 0 --> detection after turn), ex: [1,0,1,0]
...
function move_drone(req, res, next){
	...
	var number_pairs             = detect_before_after_turn.length + 1
...
//curl "http://localhost:8080/v1/move_drone/?initial_latitude=40.657963&initial_longitude=-74.618043&position_scan_latitudes=40.657870&position_scan_longitudes=-74.617942&turn_latitudes=40.657836&turn_longitudes=-74.617886&position_scan_latitudes=40.657765&position_scan_longitudes=-74.617995&turn_latitudes=40.657722&turn_longitudes=74.618069&position_scan_latitudes=40.657737&position_scan_longitudes=-74.618098&turns_degrees=90&turns_degrees=90&initial_altitude=1&normal_speed=0.1&detect_before_after_turn=1&detect_before_after_turn=0&detect_before_after_turn=1&detect_before_after_turn=0&detect_before_after_turn=1"
